        ...
        <div className="col-6 col-md-4" key={supplier.id}>
            <div className="card" styles="width: 18rem;">
                <div className="card-body">
                    <h5 className="card-title">Nombre: {product.nombreProveedor}</h5>
                    <h6 className="card-subtitle mb-2 text-muted">Celular: {product.celularProveedor}</h6>
                    <p className="card-text">NIT: {product.nit}</p>
